                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('categories.store') }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Kategori Layangan">
                                @error('name')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="price" name="price" id="price" class="form-control @error('price') is-invalid @enderror" placeholder="Biaya Pendaftaran">
                                </div>
                                @error('price')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="chest_no_prefix" id="chest_no_prefix" class="form-control @error('chest_no_prefix') is-invalid @enderror" placeholder="contoh: 1000">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="chest_no_digits" id="chest_no_digits" class="form-control @error('chest_no_digits') is-invalid @enderror" placeholder="Jumlah angka pada nomor dada layangan">
