                        ...
                        <form method="POST" action="{{ route('flights.update', $flight->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <input value="{{ old('serie') ?? $flight->serie }}" type="text" name="serie" id="serie" class="form-control @error('serie') is-invalid @enderror" placeholder="Serie Terbang">
                                    @error('serie')
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <input value="{{ old('session') ?? $flight->session }}" type="number" name="session" id="session" class="form-control @error('session') is-invalid @enderror" placeholder="Sesi Terbang">
                                    @error('session')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <select name="category_id" id="categories" class="form-control @error('category_id') is-invalid @enderror" placeholder="Select Category">
                                        @foreach ($categories as $key => $value)
                                            <option value="{{ $key }}" {{ $flight->category_id == $key ? 'selected' : ''}}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <input value="{{ old('limit') ?? $flight->limit }}" type="number" name="limit" id="limit" class="form-control @error('limit') is-invalid @enderror" placeholder="Jumlah Maksimum">
                                    @error('limit')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group mb-3 col-md-4">
                                    ...
                                    <input type="date" value="{{ old('date') ?? $flight->date }}" name="date" id="date" class="form-control @error('date') is-invalid @enderror" placeholder="">
                                    @error('date')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group mb-3 col-md-4">
                                    ...
                                    <input value="{{ old('start') ?? formatTimeHi($flight->start) }}" type="time" name="start" id="start" class="form-control @error('start') is-invalid @enderror" placeholder="">
                                    @error('start')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group mb-3 col-md-4">
                                    ...
                                    <input value="{{ old('end') ?? formatTimeHi($flight->end) }}" type="time" name="end" id="end" class="form-control @error('end') is-invalid @enderror" placeholder="">
                                    @error('end')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
