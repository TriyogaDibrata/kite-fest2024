            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex flex-row-reverse">
                        <a href="{{ route('scores.create') }}" type="button" class="btn mb-2 icon-left btn-primary "><i class="ti-plus"></i>Input Nilai</a>
                    </div>
                    <div class="card-body p-4">
                        <table id="scores_table" class="table dt-responsive display">
                            <thead>
                                <tr>
                                    {{-- <th>No</th> --}}
                                    <th>No. Peserta</th>
