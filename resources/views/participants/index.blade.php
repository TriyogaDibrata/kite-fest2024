            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex flex-row-reverse">
                        <a href="{{ route('participants.create') }}" type="button" class="btn mb-2 icon-left btn-primary "><i class="ti-plus"></i>Tambah Peserta</a>
                    </div>
                    <div class="card-body p-4">
                        <table id="participants_table" class="table dt-responsive display">
                            <thead>
                                <tr>
                                    <th>No</th>
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            var userDataTable = $('#participants_table').DataTable({
                processing: true,
                serverSide: true,
